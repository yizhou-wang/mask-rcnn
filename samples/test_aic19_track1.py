...
DATA_BASE_DIR = "/mnt/disk2/AIC19/aic19-track1-mtmc/mrcnn"
IMAGE_FOLDER = os.path.join(DATA_BASE_DIR, "crop_img_reid_test")
FOLDERLIST = os.listdir(IMAGE_FOLDER)
print('total number of folders:', len(FOLDERLIST))
FOLDERLIST.sort()
OUTPUT_PATH = os.path.join(DATA_BASE_DIR, "output_masks")
...
for folder in FOLDERLIST:
  ...
  image_dir = os.path.join(IMAGE_FOLDER, folder)
  ...
  with open(DATA_BASE_DIR + "/output_dets/dets_%s.txt"%folder, "w") as f:
    f.seek(0)
    f.truncate()
